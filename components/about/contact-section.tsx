...
export default function ContactSection() {
  return (
    <section
            ...
            {socialLinks.map((link) => (
              <motion.li
                ...
                <a
                  ...
                  <ArrowUpRight className='ml-auto size-3.5 shrink-0 text-neutral-600 transition-[color,transform] duration-300 group-hover:-translate-y-px group-hover:translate-x-px group-hover:text-white group-focus-visible:text-white' />
                </a>
              </motion.li>
            ))}
          </motion.ul>
      ...
      <footer className='mt-10 flex flex-wrap items-center justify-between gap-3 text-[11px] text-neutral-600'>
