    ...
    <div className='relative z-20 flex flex-col items-center'>
      ...
      <h1
        className={cn(
          ...
          "display-name animate-reveal text-center text-6xl leading-[0.92] tracking-[-0.03em] md:text-8xl",
        )}
      ...
      <p
        className='animate-reveal mt-5 max-w-md text-center text-sm leading-relaxed text-balance text-neutral-400 md:text-base'
