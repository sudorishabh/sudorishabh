// ARCHIVED: original portfolio landing page. Preserved (not deleted) while the
// site is blog-only. This folder is private (leading underscore), so Next.js
// does NOT route it. To restore, move this back to app/page.tsx (and remove the
// redirect there) and re-add the Home link in data/resume.tsx -> navbar.
